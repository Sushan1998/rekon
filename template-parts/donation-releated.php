<?php
    $relate_count = rekon_get_config('number_donation_releated', 2);
    $relate_columns = rekon_get_config('releated_donation_columns', 2);
...
<div class="related-posts">
    <div class="widget">
        <h3 class="widget-title">
            <span><?php esc_html_e( 'Related Campaigns', 'rekon' ); ?></span>
        </h3>
