...
$sidebar_configs = rekon_get_woocommerce_layout_configs();
?>

<?php do_action( 'rekon_woo_template_main_before' ); ?>

<section id="main-container" class="main-content <?php echo apply_filters('rekon_woocommerce_content_class', 'container');?>">
