...
class Rekon_Elementor_What_We_Do extends Widget_Base {
	...
	public function get_title() {
        return esc_html__( 'Apus What We Do', 'rekon' );
    }
...
if ( version_compare(ELEMENTOR_VERSION, '3.5.0', '<') ) {
    Plugin::instance()->widgets_manager->register_widget_type( new Rekon_Elementor_What_We_Do );
} else {
    Plugin::instance()->widgets_manager->register( new Rekon_Elementor_What_We_Do );
}