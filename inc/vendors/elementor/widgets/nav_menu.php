...
class Rekon_Elementor_Nav_Menu extends Widget_Base {
	...
	public function get_title() {
        return esc_html__( 'Apus Navigation Menu', 'rekon' );
    }
	...
	protected function register_controls() {
        ...
        $this->start_controls_section(
            'content_section',
            [
                'label' => esc_html__( 'Navigation Menu', 'rekon' ),
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => array(
                    ...
                    'inline' => esc_html__('In Line', 'rekon'),
                ),
                'default' => ''
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .widget-nav-menu .menu' => 'text-align: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->start_controls_section(
            'section_menu_style',
            [
                'label' => esc_html__( 'Menu Item', 'rekon' ),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->add_control(
            'menu_color',
            [
                'label' => esc_html__( 'Menu Color', 'rekon' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'menu_color_hover',
            [
                'label' => esc_html__( 'Menu Color Hover', 'rekon' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    // Stronger selector to avoid section style from overwriting
        ...
        $this->add_group_control(
            Group_Control_Typography::get_type(),
            [
                'label' => esc_html__( 'Menu Typography', 'rekon' ),
...
if ( version_compare(ELEMENTOR_VERSION, '3.5.0', '<') ) {
    Plugin::instance()->widgets_manager->register_widget_type( new Rekon_Elementor_Nav_Menu );
} else {
    Plugin::instance()->widgets_manager->register( new Rekon_Elementor_Nav_Menu );
}